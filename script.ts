{
  let tasks: { done: boolean; content: string }[] | [] = [];
  ...
  const addNewTask = () => {
    const newTaskContent = (<HTMLInputElement>(
    ...
    (<HTMLInputElement>document.querySelector(".js-newTask")).value = "";
  };
  ...
  const onFormSubmit = (event) => {
    ...
    addNewTask();
    (document.querySelector(".js-newTask") as HTMLElement).focus();
  };
  const render = () => {
    renderButtons();
    renderTaskContent();
